package com.h4hacks.sslpinning.h4hacks_webview.config

import com.h4hacks.sslpinning.h4hacks_webview.DomainWhitelistInterceptor
import com.h4hacks.sslpinning.h4hacks_webview.SchemeWhitelistInterceptor
...
object Config {
    ...
    private fun createCertificatePinner(): CertificatePinner {
        return CertificatePinner.Builder()
                .add(Pinning.DOMAIN_H4HACKS_COM, Pinning.CERT_H4HACKS_COM)
         //       .add(Pinning.DOMAIN_H4HACKS_COM, Pinning.CERT_INTERMEDIATE)
         //       .add(Pinning.DOMAIN_H4HACKS_COM, Pinning.CERT_CA)
                .build()
    }
